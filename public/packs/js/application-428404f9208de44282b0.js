...
function check() {
  ...
  posts.forEach(function (post) {
    ...
    post.addEventListener("click", function () {
      ...
      var postId = post.getAttribute("data-id"); // Ajaxに必要はオブジェクトを生成している
...
function memo() {
  ...
  submit.addEventListener("click", function (e) {
    ...
    XHR.onload = function () {
      ...
      formText.value = ""; // 上記１行のコードによりメモの入力フォームに入力されたままの文字はリセットされる
...
/******/ });
//# sourceMappingURL=application-428404f9208de44282b0.js.map